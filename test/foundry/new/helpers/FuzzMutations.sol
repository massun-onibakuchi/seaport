...
contract FuzzMutations is Test, FuzzExecutor {
    ...
    function mutation_invalidSigner_BadSignature(
        ...
        console.log(
            "inside mutation invalid signer bad signature",
            context.mutationState.selectedOrderIndex
        );
